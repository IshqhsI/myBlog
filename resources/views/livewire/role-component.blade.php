<div class="w-full">
    ...
    <div class="flex">
        ...
        <div class="w-1/2 text-end">
            <input type="text" class="form-control w-full md:w-1/2 rounded p-2 border-blue-600" placeholder="Search" wire:keydown="searchRole" wire:model="search">
        </div>
    </div>
    ...
    <table class="min-w-full bg-white shadow-md rounded-lg overflow-hidden dark:bg-gray-800 dark:text-gray-100 mt-5">
        <thead class="bg-blue-600 text-white dark:bg-blue-700">
            <tr>
                ...
                <th class="py-3 px-6 text-left">Name Role</th>
            ...
            @if ($roles->count() > 0)
                @foreach ($roles as $i => $role)
                    <tr class="border-b dark:border-gray-600">
                        ...
                        <td class="py-3 px-6 text-left">{{ $role->guard_name }}</td>
